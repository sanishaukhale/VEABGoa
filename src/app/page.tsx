...
import { ArrowRight, Leaf, Users, Sprout as ProjectIcon, CalendarDays as EventIcon } from "lucide-react"; // Renamed Sprout to ProjectIcon
...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-[70vh] min-h-[400px] flex items-center justify-center text-center bg-primary/10">
        <Image
